...
document.getElementById('resultados').textContent = `Resultadosdebúsquedapara"${terminoBusqueda}":`; 
...
document.getElementById('resultados').textContent = encontraronresultados; 
} 
} catch (error) { 
